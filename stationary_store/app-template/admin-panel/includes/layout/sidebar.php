            ...
            <ul class="nav flex-column pe-3">
                <li class="nav-item">
                    <a class="nav-link link-body-emphasis text-decoration-none d-flex align-items-center gap-2 text-secondary"
                        href="/project/app-template/admin-panel/index.php">
                ...
                <li class="nav-item">
                    <a class="nav-link link-body-emphasis text-decoration-none d-flex align-items-center gap-2 text-secondary"
                        href="/project/app-template/admin-panel/pages/reports/index.php">
                        <i class="bi bi-bar-chart-fill fs-4 text-secondary"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link link-body-emphasis text-decoration-none d-flex align-items-center gap-2"
                        href="/project/app-template/admin-panel/pages/products/index.php">
                ...
                <li class="nav-item">
                    <a class="nav-link link-body-emphasis text-decoration-none d-flex align-items-center gap-2"
                        href="/project/app-template/admin-panel/pages/categories/index.php">
                ...
                <li class="nav-item">
                    <a class="nav-link link-body-emphasis text-decoration-none d-flex align-items-center gap-2"
                        href="/project/app-template/admin-panel/pages/comments/index.php">
